...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[2rem] border border-primary/10 bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm transition-all hover:shadow-xl hover:border-primary/20",
      className
    )}
    {...props}
  />
